...
public class unitTestOfWURCStoWURCS {
    ...
    public void monosaccharide () {
        ...
        String outWURCS = toWURCS(inWURCS(testWURCS));
        Assert.assertEquals(testWURCS, outWURCS);
    }
    ...
    public void bridge2 () {
        ...
        String testWURCS = "WURCS=2.0/2,8,7/[a1122h-1a_1-5][a2112h-1b_1-5]/1-2-1-2-1-2-1-1/a4-b1_b6-c1*OPO*/3O/3=O_c4-d1_d6-e1*OPO*/3O/3=O_e4-f1_f6n1-g1n2*1OP^X*2/3O/3=O_g2-h1";
        String outWURCS = toWURCS(inWURCS(testWURCS));
        Assert.assertEquals(testWURCS, outWURCS);
    }
    ...
    public void cyclicModification () {
        ...
        String testWURCS = "WURCS=2.0/6,8,7/[a2122h-1x_1-5][a2122h-1b_1-5][a2122A-1b_1-5][a21FFA-1a_1-?][a2122h-1b_1-5_4-6*OC^XO*/3CO/6=O/3C][a2112h-1b_1-5_4-6*OC^XO*/3CO/6=O/3C]/1-2-3-4-2-2-5-6/a4-b1_a6-e1_b4-c1_c4-d1_e4-f1_f4-g1_g3-h1";
        String outWURCS = toWURCS(inWURCS(testWURCS));
        Assert.assertEquals(testWURCS, outWURCS);
    }
    ...
    public void fragment () {
        ...
        String testWURCS = "WURCS=2.0/6,11,10/[a2122h-1x_1-5_2*NCC/3=O][a2122h-1b_1-5_2*NCC/3=O][a1122h-1b_1-5][a1122h-1a_1-5][a2112h-1b_1-5][a1221m-1a_1-5]/1-2-3-4-2-5-4-2-6-2-5/a4-b1_a6-i1_b4-c1_c3-d1_c6-g1_d2-e1_e4-f1_g2-h1_j4-k1_j1-d4|d6|g4|g6}";
        String outWURCS = toWURCS(inWURCS(testWURCS));
        Assert.assertEquals(testWURCS, outWURCS);
    }
    ...
    private String toWURCS (GlyContainer _gc) {
        try {
            ExporterEntrance ee = new ExporterEntrance(_gc);
            return ee.toWURCS();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private GlyContainer inWURCS (String _wurcs) {
        try {
