...
public class UnitTextWURCS2WURCSviaIUPACCondensed {
    ...
    public String toIUPAC(String _wurcs) {
        try {
        ...
        } catch (GlycanException | WURCSException | GlyCoExporterException | TrivialNameException e) {
            e.printStackTrace();
//            System.out.println(e.getMessage());
    ...
    public String toIUPACEx (String _wurcs) {
        try {
            WURCSImporter wi = new WURCSImporter();
            GlyContainer gc = wi.start(_wurcs);
