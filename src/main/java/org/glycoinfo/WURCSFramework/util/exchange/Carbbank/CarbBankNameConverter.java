...
import org.glycoinfo.WURCSFramework.util.exchange.SubstituentConverter;
import org.glycoinfo.WURCSFramework.util.exchange.TrivialNameConverter;
...
public class CarbBankNameConverter {
	...
	public String makeIUPACExtendedNotation(ResidueContainer a_objRC) 
			throws WURCSFormatException, ConverterExchangeException {
	...
	public String createIUPACondensedNotation (ResidueContainer a_oRC) throws WURCSFormatException, ConverterExchangeException {
		/** convert the monosaccharide name official name to trival name*/
